...
// --- Icons ---
import { BoldIcon } from "~/integrations/tiptap/icons/bold-icon"
import { Code2Icon } from "~/integrations/tiptap/icons/code2-icon"
import { ItalicIcon } from "~/integrations/tiptap/icons/italic-icon"
import { StrikeIcon } from "~/integrations/tiptap/icons/strike-icon"
import { SubscriptIcon } from "~/integrations/tiptap/icons/subscript-icon"
import { SuperscriptIcon } from "~/integrations/tiptap/icons/superscript-icon"
import { UnderlineIcon } from "~/integrations/tiptap/icons/underline-icon"
